      ...
      <div className="min-h-screen bg-gradient-to-b from-[#0a1628] via-[#1a2f4f] to-[#0a1628] flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-4 text-center">
            <p className="text-blue-200/50 text-sm">Didn't receive the code? Check your spam folder.</p>
          </div>
        </div>
      </div>
    );
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="fullName" type="text" placeholder="John Doe" value={name}
          ...
          <div className="flex items-start space-x-2 pt-2">
            ...
            <label htmlFor="terms" className="text-sm text-blue-200/70 cursor-pointer leading-tight">
