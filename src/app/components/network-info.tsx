...
import {
  ArrowLeft, Wifi, Shield, Lock, Server, Check, Activity, Globe, Cloud
} from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">
                      {connectionMode === "internet" ? "Connected" : "Connected"}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-blue-200/70">Connection Quality</p>
        ...
        <div className="mb-6">
          ...
          <Card className="bg-white/5 border-blue-400/20 backdrop-blur-sm p-6">
            <div className="space-y-4">
              <p className="text-blue-200/70 text-sm">
                This application operates on a secure network, communicating with IoT devices through an encrypted gateway using industry-standard security protocols.
              </p>
              <div className="space-y-3 mt-4">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-white">Secure Gateway</p>
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-white">Cloud & AI Analysis</p>
                    <p className="text-blue-200/50 text-xs">AI model analyzes traffic for threats</p>
                  </div>
                </div>
                <div className="ml-4 w-px h-6 bg-blue-400/20"></div>
                <div className="flex items-center gap-3 text-sm">
              ...
              <>
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200/50 text-xs">Operates entirely on local network</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
              ...
              <>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-blue-200/50 text-xs">Control your devices from anywhere</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-blue-100">AI Threat Detection</span>
                    <p className="text-blue-200/50 text-xs">Real-time anomaly detection powered by machine learning</p>
                  </div>
                </div>
              </>
            )}
